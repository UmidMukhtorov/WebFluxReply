...
class OrderResourceIT {
    ...
    private static final String DEFAULT_PRODUCTID = "AAAAAAAAAA";
    private static final String UPDATED_PRODUCTID = "BBBBBBBBBB";
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().clientid(DEFAULT_CLIENTID).productid(DEFAULT_PRODUCTID);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().clientid(UPDATED_CLIENTID).productid(UPDATED_PRODUCTID);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getClientid()).isEqualTo(DEFAULT_CLIENTID);
        assertThat(testOrder.getProductid()).isEqualTo(DEFAULT_PRODUCTID);
    }
    ...
    void getAllOrders() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].clientid")
            .value(hasItem(DEFAULT_CLIENTID))
            .jsonPath("$.[*].productid")
            .value(hasItem(DEFAULT_PRODUCTID));
    }
    ...
    void getOrder() {
        ...
        webTestClient
            ...
            .jsonPath("$.clientid")
            .value(is(DEFAULT_CLIENTID))
            .jsonPath("$.productid")
            .value(is(DEFAULT_PRODUCTID));
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.clientid(UPDATED_CLIENTID).productid(UPDATED_PRODUCTID);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getClientid()).isEqualTo(UPDATED_CLIENTID);
        assertThat(testOrder.getProductid()).isEqualTo(UPDATED_PRODUCTID);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.clientid(UPDATED_CLIENTID);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.clientid(UPDATED_CLIENTID).productid(UPDATED_PRODUCTID);
